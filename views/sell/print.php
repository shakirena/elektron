...
<div id="inf" style="width:250px;" align='center' onafterprint="myFunction()">
    ...
    <p style="font-size:10pt;" >Tarix: <?php echo date("Y-m-d H:i:s"); ?><br>Çekin nömrəsi: <?php echo $number; ?><br/><?php echo Client::find()->where(["id_client"=>$client])->one()->fio; ?></p>
        ...
        <?= GridView::widget([
            ...
            'tableOptions' => [
               ...
               'style' => 'font-size:8pt;border:2px solid;    ',
				 'class' => 'table-print',
            ],
			'rowOptions'=>
...
if ($virtual)
	{
		if ($kassa==1)
		echo "Bonus ilə ödənib: ".$virtual."<br>";
		else echo "POS: ".$virtual."<br>";
...
?>
    <p align='left'  class="test" style="font-size:10pt;">Təşəkkür edirik!</p>
...
</svg> <b>_elektron.zaqatala_</b> </br>
