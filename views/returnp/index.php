        ...
        'columns' => [
                ...
                'groupHeader' =>function ($model, $index, $widget) {
                    return [
                        ...
                        'content' =>[
                          ...
                          //  5=> $model->getSumNumber($model->number),
						    5=>GridView::F_SUM,
                            7=>GridView::F_SUM,
			...
			[
                ...
                'value' =>  function ($model, $key, $index, $column) {
											return Html::button('<i class="glyphicon glyphicon-remove"></i>',["onclick"=> "cancelReturn($model->number)",'class' => 'btn btn-primary btn-xs']);
								},
                 'format' => 'raw',
            ],
            [
		   ...
		   [
		     ...
		     [
				'label'=>'Cəmi',
				'value' => 'sumValue',
               'footer' => $searchModel->getSumSum($dataProvider->query),
           ] ,
            ...
            [
			 ...
			 [
                ...
                'hAlign' => 'right',
				'filter'=>false,
               'footer' => round($searchModel->getSumVal($dataProvider->query),2)
            ],
			  [
                ...
                'hAlign' => 'right',
				'filter'=>false,
                'footer' => round($searchModel->getSumEarning($dataProvider->query),2)
            ],
            [
                'attribute'=> 'reason',
                'width' => '200px',
