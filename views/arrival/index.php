...
<div class="arrival-index">
  <div class="noprint">
    ...
    <div class="btn-group">
        <?= Html::button('<i class="glyphicon glyphicon-search"></i>Axtarış', ['value' => Url::to(['arrival/find']), 'class' => 'btn btn-warning', 'id' => 'modalButton']) ?>
    </div>

   <div class="btn-group">
        <?= Html::button('<i class="glyphicon glyphicon-time"></i> Gözləmədə', ['value' => Url::to(['arrival/postponed']), 'class' => 'btn btn-info', 'id' => 'postponed_dialog']) ?>
...
?>
	...
	<?php 
					   ...
					   // 'id_user',
						...
						[
							...
							'value' => function ($model, $index, $widget)  use (&$i) {
								 $i++;
								return Html::input('text', 'quantity[]', $model->quantity, ['class' => 'form-control input-sm', 'size' => '3', 'onChange' => "editQuantity($model->id,this.value,$i)"]);
							}
						],
						[
							'attribute' => 'price',
							...
							'value' => function ($model, $index, $widget)  use (&$i) {
					            ...
					            return Html::input('text', 'price[]', $model->price, ['class' => 'form-control input-sm', 'size' => '3','id'=>"price".$i, 'onChange' => "editPrice($model->id,this.value,$i)"]);
							}
						],
						...
						[
							...
							'value' => function ($model, $index, $widget)  use (&$i) {
						        ...
						        return Html::input('text', 'pricesell[]', $model->pricesell, ['class' => 'form-control input-sm', 'size' => '3','id'=>"pricesell".$i, 'onChange' => "editPricesell($model->id,this.value,$i)"]);
							}
						],
						[   
							...
							'format' => 'raw',
							'value' => function ($model, $index, $widget)  use (&$i) {
								return Html::input('text', 'trade_price[]', $model->trade_price, ['class' => 'form-control input-sm', 'size' => '3', 'onChange' => "editTradePrice($model->id,this.value,$i)",'id'=>'trade_price'.$i]);
							}
						],
							/*[
							'attribute' => 'pricesell_min',
							'format' => 'raw',
							'encodeLabel' => false,
							
							'value' => function ($model, $index, $widget)  use (&$i) {

						        return Html::input('text', 'pricesell_min[]', $model->pricesell_min, ['class' => 'form-control input-sm', 'size' => '3','id'=>"pricesell_min".$i, 'onChange' => "editPricesellMin($model->id,this.value,$i)"]);
							}
						],
						...
						[
							...
							'format' => 'raw',
							'encodeLabel' => false,
							'label' =>'Satış <br /> qiyməti (USD)',
							'value' => function ($model, $index, $widget) {
								return Html::input('text', 'usdsell[]', $model->usdsell, ['class' => 'form-control input-sm', 'size' => '3', 'onChange' => "editUsdsell($model->id,this.value)"]);
							}
						],
						*/
						[
							...
							'label' =>'Faiz',
							'value' => function ($model, $index, $widget) {
								return Html::input('text', 'proc[]', $model->discount, ['class' => 'form-control input-sm', 'size' => '3', 'onChange' => "editProcId($model->id,this.value)"]);
							}
						],
						[
					...
					/*	[   
							...
							'format' => 'raw',
							'value' => function ($model, $index, $widget) {
								return Html::input('text', 'boxing[]', $model->boxing, ['class' => 'form-control input-sm', 'size' => '3', 'onChange' => "editBoxing($model->id,this.value)",'id'=>'boxing'.$model->id]);
							}
						],*/
			/*
						[
							'value' => function ($model, $index, $widget) {
								return $model->usd*$model->quantity;
							},

							'label' => 'Cəmi <br>qiyməti (USD)',
							'encodeLabel' => false,
				...
				*/		
						...
						'buttons' => [
							'delete' =>function ($url, $model) {
								return Html::button('<i class="glyphicon glyphicon-delete"></i>Silmək',['onclick'=>" deleteArrival($model->id)"]);}
						],
...
<div  class='arrivalBraches'>
    ...
    <?= Html::button('<i class="glyphicon glyphicon-ok"></i>  OK', ['class' => 'btn btn-success', 'onclick' => 'receivedArrival($("#store8").val(),$("#contractor").val(),$("#date").val(),0)']); ?>
    <?= Html::button('<i class="glyphicon glyphicon-time"></i>  Gözləmə', ['class' => 'btn btn-info', 'onclick' => 'postponedArrival($("#store8").val(),$("#contractor").val())']); ?>
<br><br>
   <?= Html::button('<i class="glyphicon glyphicon-remove"></i> Hamsını sil', ['class' => 'btn btn-danger', 'onclick' => 'deleteAll()']); ?>
</br></br>	 
	 <?= Html::button('<i class="glyphicon glyphicon-share-alt"></i> Vozrat', ['class' => 'btn btn-warning', 'onclick' => 'returnArrivalPassword()']); ?>
	 </br> </br>
	<?= Html::button('<i class="glyphicon glyphicon-share-alt"></i> Ok(Ştrixkodun çapı)', ['class' => 'btn btn-info', 'onclick' => 'receivedArrival($("#store8").val(),$("#contractor").val(),$("#date").val(),1)']); ?>
</div>
    <?php Pjax::end(); ?>
</div>
  </div>
