 ...
 */
class DclientSearch extends Dclient
{
    public $date_start;
    public $date_end;
    /**
    ...
    {
         $query = Dclient::find()->select("sum(debt) as debt_sum, sum(sum) as sum,sum(usd) as usd,id_client")->where("id_client>1")->groupBy("id_client")->orderBy("debt_sum DESC");
