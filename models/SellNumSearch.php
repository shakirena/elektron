 ...
 */
class SellNumSearch extends Sell
{
    ...
    {
        $query = Sell::find()->select("datetime,sum(sum) as sum,sum(quantity) as quantity,price,sell.id_product,sum(earnings) as earnings")->groupBy("id_product")->orderBy("sell.id DESC");
